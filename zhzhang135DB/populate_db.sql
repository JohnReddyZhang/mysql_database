...
load data
LOCAL INFILE "/data/entity_dish.txt"
...
load data
LOCAL INFILE "/data/entity_flavor.txt"
REPLACE INTO TABLE Flavor
FIELDS TERMINATED BY '|'
(`flavorName`, `strength`);

load data
LOCAL INFILE "/data/entity_kitchenware.txt"
REPLACE INTO TABLE KitchenWare
FIELDS TERMINATED BY '|'
(`wareName`, `photo`);

load data
LOCAL INFILE "/data/entity_kitchenware_utensil.txt"
REPLACE INTO TABLE Utensil
FIELDS TERMINATED BY '|'
(`kitchenWareName`, `photoLink`);

load data
LOCAL INFILE "/data/entity_kitchenware_appliance.txt"
REPLACE INTO TABLE Appliance
FIELDS TERMINATED BY '|'
(`kitchenWareName`, `purpose`);

load data
LOCAL INFILE "/data/entity_kitchenware_containers.txt"
REPLACE INTO TABLE Containers
FIELDS TERMINATED BY '|'
(`kitchenWareName`, `capacity`);

load data
LOCAL INFILE "/data/entity_store.txt"
REPLACE INTO TABLE Store
FIELDS TERMINATED BY '|'
(`storeName`, `brandPhotoLink`, `location`,`zip`);

load data
LOCAL INFILE "/data/entity_store_isle.txt"
